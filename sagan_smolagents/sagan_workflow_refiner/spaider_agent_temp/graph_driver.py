#!/usr/bin/env python3
"""
Simple driver component for workflow_refiner that creates the langgraph graph object and prints the mermaid diagram.
"""
...
def main():
    ...
    """
    print("Creating langgraph graph object for workflow_refiner...")
    
    # Create the graph builder with a default session_id
    session_id = "default_session"
    builder = create_graph(session_id)
